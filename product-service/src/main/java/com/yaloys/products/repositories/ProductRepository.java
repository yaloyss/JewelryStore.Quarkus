...
public class ProductRepository implements PanacheRepository<Product> {
    ...
    public List<Product> findByMetal(Integer metalId) {
        return list("metalId", metalId);
    }

    public List<Product> findByStone(Integer stoneId) {
        return list("stoneId", stoneId);
    }
...
//        {
//            productStones.put(product.getProductId(), new ArrayList<>(product.getStoneId()));
//        }
//
//        return product;
//    }
...
//        product.setStoneId(getProductStones(product.getProductId()));
//    }
}
